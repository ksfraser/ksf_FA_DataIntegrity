...
echo "<tr class='integ-group-header'><td colspan='5'>" . _('Purchase Chain (P1&#8212;P13, PCHAIN)') . "</td></tr>\n";

$purchase_checks = array('P1', 'P2', 'P3', 'P4', 'P5', 'P6', 'P7', 'P8', 'P9', 'P10', 'P11', 'P12', 'P13', 'PCHAIN');
$k = 0;
...
// Sales chain group
echo "<tr class='integ-group-header'><td colspan='5'>" . _('Sales Chain (S1&#8212;S10, SCHAIN, SCUST)') . "</td></tr>\n";

$sales_checks = array('S1', 'S2', 'S3', 'S4', 'S5', 'S6', 'S7', 'S8', 'S9', 'S10', 'SCHAIN', 'SCUST');
